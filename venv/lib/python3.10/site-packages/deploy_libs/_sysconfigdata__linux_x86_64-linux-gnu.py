...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/_internal/cpython-3.10.19/bin',
 'BINLIBDEST': '/opt/_internal/cpython-3.10.19/lib/python3.10',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-g -O2 -Wall -fdebug-prefix-map=/=. '
                            '-fstack-protector-strong -Wformat '
                            '-Werror=format-security -Wdate-time '
                            '-D_FORTIFY_SOURCE=2 -std=c99 -Wextra '
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now',
 'CONFIG_ARGS': "'CC=gcc' 'CXX=g++' 'CFLAGS_NODIST=-g -O2 -Wall "
                '-fdebug-prefix-map=/=. -fstack-protector-strong -Wformat '
                "-Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' "
                "'LDFLAGS_NODIST=-Wl,-Bsymbolic-functions -Wl,-z,relro "
                "-Wl,-z,now ' '--prefix=/opt/_internal/cpython-3.10.19' "
                "'--disable-shared' '--with-ensurepip=no' "
                "'--with-openssl=/opt/_internal/openssl-3.5' "
                "'--with-openssl-rpath=auto' "
                "'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/opt/_internal/cpython-3.10.19/include',
 'CONFINCLUDEPY': '/opt/_internal/cpython-3.10.19/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Python-3.10.19/coverage.info',
 'COVERAGE_REPORT': '/Python-3.10.19/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/opt/_internal/cpython-3.10.19 '
             '/opt/_internal/cpython-3.10.19/lib '
             '/opt/_internal/cpython-3.10.19/lib/python3.10 '
             '/opt/_internal/cpython-3.10.19/lib/python3.10/lib-dynload',
 'DESTLIB': '/opt/_internal/cpython-3.10.19/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/opt/_internal/cpython-3.10.19/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.10.19/include '
                   '/opt/_internal/cpython-3.10.19/include '
                   '/opt/_internal/cpython-3.10.19/include/python3.10 '
                   '/opt/_internal/cpython-3.10.19/include/python3.10',
 'INCLUDEDIR': '/opt/_internal/cpython-3.10.19/include',
 'INCLUDEPY': '/opt/_internal/cpython-3.10.19/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/opt/_internal/cpython-3.10.19/lib/python3.10',
 'LIBDIR': '/opt/_internal/cpython-3.10.19/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/_internal/cpython-3.10.19/lib/pkgconfig',
 'LIBPL': '/opt/_internal/cpython-3.10.19/lib/python3.10/config-3.10-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/_internal/cpython-3.10.19/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/_internal/cpython-3.10.19/share/man',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/_internal/openssl-3.5/include',
 'OPENSSL_LDFLAGS': '-L/opt/_internal/openssl-3.5/lib',
 ...
 'PY_CFLAGS_NODIST': '-g -O2 -Wall -fdebug-prefix-map=/=. '
                     '-fstack-protector-strong -Wformat '
                     '-Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -g -O2 -Wall -fdebug-prefix-map=/=. '
                   '-fstack-protector-strong -Wformat -Werror=format-security '
                   '-Wdate-time -D_FORTIFY_SOURCE=2 -std=c99 -Wextra '
                   '-Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I./Include/internal -I. -I./Include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now',
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -g -O2 -Wall -fdebug-prefix-map=/=. '
                        '-fstack-protector-strong -Wformat '
                        '-Werror=format-security -Wdate-time '
                        '-D_FORTIFY_SOURCE=2 -std=c99 -Wextra '
                        '-Wno-unused-result -Wno-unused-parameter '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/opt/_internal/cpython-3.10.19/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/Python-3.10.19',
 'abs_srcdir': '/Python-3.10.19',
 'datarootdir': '/opt/_internal/cpython-3.10.19/share',
 'exec_prefix': '/opt/_internal/cpython-3.10.19',
 'prefix': '/opt/_internal/cpython-3.10.19',
 'srcdir': '.'}
